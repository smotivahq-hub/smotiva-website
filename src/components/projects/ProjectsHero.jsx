...
export default function ProjectsHero() {
  ...
  return (
    // Section uses a dark background matching the Project.jpg UI
    <section ref={ref} className="bg-secondary-dark pt-24 pb-16 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          A chronicle of our integrated design and development work experience. Each project highlights creativity, functionality, and real results.
        </motion.p>
      </div>
    </section>
  );
